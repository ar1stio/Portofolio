...
class Header extends REST_Controller {
    ...
    function child_get(){
        ...
        $row = $this->db->query("select headerchild.kodeheader, headerchild.kodeheaderchild, headerchild.titlebutton, headerchild.ling , headerchild.status from header inner join headerchild on header.kodeheader=headerchild.kodeheader")->result();
        if ($row)
