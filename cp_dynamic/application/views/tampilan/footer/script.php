...
function lihat(kodelihat){
        //console.log(kode);
  $.get("http://localhost/api_casakandara/index.php/footer/detail?kodeheader="+kodelihat+"&batas=10", function(data, status){
      var row = "";
...
function ambillimitdetail(){
  ...
  $.get("http://localhost/api_casakandara/index.php/footer/detail?kodeheader="+kodeheader+"&batas="+batasdetail, function(data, status){
      var row = "";
      $('#detaildata').empty(row);
      if (data.length){
          for (p in data){            
...
function simpanheader(){
  ...
  if (kodeheader){
    ...
    $.ajax({
        type: 'POST',
        url: "http://localhost/api_casakandara/index.php/footer/editfotoheader",
        dataType: 'json',
        cache: false,
        contentType: false,
        processData: false,
...
function hapusfotoheader(){   
  ...
  $.ajax({
   type: "POST",
   url: "http://localhost/api_casakandara/index.php/footer/hapusfoto",
   cache: false,
   contentType: false,
   data: form_data,
   dataType : "json",
...
function simpanheaderdetil(){
  ...
  if (kodeheader){
    ...
    $.ajax({
        type: 'POST',
        url: "http://localhost/api_casakandara/index.php/footer/headerdetail",
        dataType: 'json',
        cache: false,
        contentType: false,
        processData: false,
